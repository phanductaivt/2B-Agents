...
# User Story: Loyalty Overview Expansion

- Story ID: `US-001`
- Parent FR ID: `FR-001`
- Parent REQ ID: `REQ-001`
## Story
As a member, I want to view my points and tier progress clearly so that I understand my loyalty status without contacting support.

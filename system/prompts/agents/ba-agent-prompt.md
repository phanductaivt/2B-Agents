...
- structure business notes
- draft BPMN-style process output in Mermaid
- write user stories and acceptance criteria when ready
- analyze current and future processes
- draft BRD and agile-style FRS outputs
- derive feature hierarchy from requirements
- group features into Level 1, Level 2, and Level 3 structure
